...
const GamingScreen = () => {
  ...
  const products: ProductItem[] = [
    { id: '1', name: 'PlayStation 5', price: 499, rating: 4.9, image: 'https://via.placeholder.com/150x150?text=PlayStation+5', category: 'gaming' },
    { id: '2', name: 'Xbox Series X', price: 499, rating: 4.8, image: 'https://via.placeholder.com/150x150?text=Xbox+Series+X', category: 'gaming' },
    { id: '3', name: 'Nintendo Switch OLED', price: 349, rating: 4.7, image: 'https://via.placeholder.com/150x150?text=Nintendo+Switch+OLED', category: 'gaming' },
    { id: '4', name: 'Steam Deck', price: 399, rating: 4.6, image: 'https://via.placeholder.com/150x150?text=Steam+Deck', category: 'gaming' },
    { id: '5', name: 'Gaming Headset Pro', price: 199, rating: 4.5, image: 'https://via.placeholder.com/150x150?text=Gaming+Headset+Pro', category: 'gaming' },
    { id: '6', name: 'Gaming Mouse RGB', price: 79, rating: 4.4, image: 'https://via.placeholder.com/150x150?text=Gaming+Mouse+RGB', category: 'gaming' },
  ];
  ...
  const filterCategories = [
    ...
    { id: 'console', label: 'Console', icon: 'game-controller' },
    { id: 'accessories', label: 'Accessories', icon: 'headset' },
    { id: 'pc-gaming', label: 'PC Gaming', icon: 'desktop' },
    { id: 'mobile-gaming', label: 'Mobile Gaming', icon: 'phone-portrait' },
  ];
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <View style={styles.header}>
          <Text style={styles.title}>Gaming & Entertainment</Text>
        ...
        <View style={styles.productsContainer}>
          <Text style={styles.productsTitle}>
            {filteredProducts.length} gaming product{filteredProducts.length !== 1 ? 's' : ''} found
          </Text>
          <FlatList
