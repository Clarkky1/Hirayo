...
const products: ProductItem[] = [
  ...
  },
  {
    ...
    price: 799,
    rating: 4.7,
    image: 'https://via.placeholder.com/150x150?text=Galaxy+Tab+S9',
    category: 'tablet'
  },
  {
    id: '3',
  ...
  },
  {
    ...
    price: 399,
    rating: 4.5,
    image: 'https://via.placeholder.com/150x150?text=Tab+P11+Pro',
    category: 'tablet'
  },
  {
    id: '5',
    ...
    price: 149,
    rating: 4.3,
    image: 'https://via.placeholder.com/150x150?text=Fire+HD+10',
    category: 'tablet'
  },
  {
    id: '6',
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Tablets & iPads</Text>
        <Text style={styles.subtitle}>Discover amazing tablets for work and play</Text>
      </View>
      ...
      <View style={styles.searchContainer}>
        <View style={styles.searchBar}>
          ...
          <TextInput
            ...
            placeholder="Search tablets, iPads, accessories..."
            value={searchQuery}
