  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Smartphones & Phones</Text>
        <Text style={styles.subtitle}>Discover the latest mobile devices</Text>
      </View>
      ...
      <View style={styles.searchContainer}>
        <View style={styles.searchBar}>
          ...
          <TextInput
            ...
            placeholder="Search smartphones, phones, accessories..."
            value={searchQuery}
